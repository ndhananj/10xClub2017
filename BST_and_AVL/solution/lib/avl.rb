...
class AVLTree
  ...
  def self.double_rotation!(root, dir)
    other_dir = dir == 0 ? 1 : 0
    new_root = root.subtrees[other_dir].subtrees[dir]

    root.subtrees[other_dir].subtrees[dir] = new_root.subtrees[other_dir]
    new_root.subtrees[other_dir] = root.subtrees[other_dir]
    root.subtrees[other_dir] = new_root
